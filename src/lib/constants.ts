...
// Backward compatibility aliases (superseded by the full PSGC dataset in
// src/lib/ph-locations.ts — kept only where still imported).
...
export const DEFAULT_STATION_PAYMENT_METHODS = ["gcash"];
